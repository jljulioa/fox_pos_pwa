...
import { Building2, MapPin, FileText, FileSignature, Loader2, Save, CheckCircle2 } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Since there's no primary key, we check if a record exists by checking if originalName was set
      if (originalName) {
